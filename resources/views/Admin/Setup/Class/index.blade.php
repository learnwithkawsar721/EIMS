        ...
        <div class="card-body">
            <div class="heading-layout1">
                <div class="item-title">
                    <h3>All Class
                        <a href="{{ route('classSetup.create') }}"
                    ...
                    <tbody>
                        @foreach ($all_class as $item)
                            ...
                            <tr>
                                ...
                                <td>
                                    <button value="{{ route('classSetup.edit', $item->id) }}"
                                        class="btn-fill-md text-light bg-dodger-blue btn-hover-bluedark add_button edit_submit_btn">Edit</button>
                                    <button value="{{ route('classSetup.delete',$item->id) }}" class="btn-fill-md radius-4 text-light bg-orange-red btn-hover-bluedark add_button delete_btn">Delete</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
