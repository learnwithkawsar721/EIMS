...
@section('dashboard')
    ...
    <div class="card height-auto">
        <div class="card-body">
            ...
            <form class="new-added-form" action="{{ route('expensessetup.update',$expenses->id) }}" method="POST">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-12 form-group ">
                        <label>Session *</label>
                        <input type="text" value="{{ $expenses->expenses_name }}" name="expenses_name" placeholder="Enter New Expenses Name" class="form-control">
                        @error('expenses_name')
