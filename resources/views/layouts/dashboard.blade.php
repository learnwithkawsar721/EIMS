...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 May 2020 15:00:39 GMT -->
...
<head>
    ...
    <style>
        .add_button{
            padding: 6px 20px; font-weight: 400; font-size:14px;
            color: #fff;
        }
        .add_button:hover{
            color: #fff;
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <div class="item-content">
                                <ul class="settings-list">
                                    ...
                                    <li>
                                        <a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout_from').submit();"><i class="flaticon-turn-off"></i>Log Out</a>
                                        <form id="logout_from" action="{{ route('logout') }}" method="post" class="d-none">
                                            @csrf
                                        </form>
                                    </li>
                                </ul>
                            ...
                            <div class="item-content">
                                <div class="media">
                                    <div class="item-img bg-skyblue author-online">
                                        <img src="{{ asset('dashboard') }}/img/figure/student11.png" alt="img">
                                    </div>
                                ...
                                <div class="media">
                                    <div class="item-img bg-yellow author-online">
                                        <img src="{{ asset('dashboard') }}/img/figure/student12.png" alt="img">
                                    </div>
                                    <div class="media-body space-sm">
                                        <div class="item-title">
                                            <a href="#">
                                ...
                                <div class="media">
                                    <div class="item-img bg-pink">
                                        <img src="{{ asset('dashboard') }}/img/figure/student13.png" alt="img">
                                    </div>
                                    <div class="media-body space-sm">
                                        <div class="item-title">
                                            <a href="#">
        ...
        <div class="dashboard-page-one">
               ...
               <div class="mobile-sidebar-header d-md-none">
                ...
                <div class="sidebar-menu-content">
                    <ul class="nav nav-sidebar-menu sidebar-toggle-view">
                        {{-- admin link chack role Start --}}
                        @if (Auth::user()->role == 1)

                        <li class="nav-item @yield('home')">
                            <a href="{{ route('admin') }}" class="nav-link"><i class="flaticon-dashboard"></i><span>Dashboard</span></a>

                        </li>
                        <li class="nav-item sidebar-nav-item @yield('setup')">
                            <a href="#" class="nav-link"><i
                                    class="flaticon-multiple-users-silhouette"></i><span>All Setup</span></a>
                        ...
                        @endif
                        {{-- admin link chack role End --}}

                        {{-- Teacher link chack role Start --}}
                        @if (Auth::user()->role == 2)

                        <li class="nav-item @yield('home')">
                            <a href="{{ route('teacher') }}" class="nav-link"><i class="flaticon-dashboard"></i><span>Dashboard</span></a>

                        </li>
                        @endif
                        {{-- Teacher link chack role End --}}

                        {{-- Parents link chack role Start --}}
                        @if (Auth::user()->role == 3)

                        <li class="nav-item @yield('home')">
                            <a href="{{ route('parents') }}" class="nav-link"><i class="flaticon-dashboard"></i><span>Dashboard</span></a>

                        </li>
                        @endif
                        {{-- Parents link chack role End --}}

                         {{-- Student link chack role Start --}}
                        @if (Auth::user()->role == 4)

                        <li class="nav-item @yield('home')">
                            <a href="{{ route('student') }}" class="nav-link"><i class="flaticon-dashboard"></i><span>Dashboard</span></a>

                        </li>
                        @endif
                        {{-- Student link chack role End --}}
            ...
            <div class="dashboard-content-one">
                ...
                <footer class="footer-wrap-layout1">
                    <div class="copyright">© Copyrights <a href="#">akkhor</a> {{ date('Y') }}. All rights reserved. Designed by <a
                            href="#">PsdBosS</a></div>
                </footer>
...
<!-- Mirrored from www.radiustheme.com/demo/html/psdboss/akkhor/akkhor/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 May 2020 15:00:42 GMT -->
</html>
